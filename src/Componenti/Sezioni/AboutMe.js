        ...
        <div>
            <CardContent className={[mainStyles.resumeBackground, mainStyles.elementToFadeInAndOut]}>
                <Grid container>
                    ...
                    <Grid contaier>
                        <Grid item>
                            <Typography style={{ fontWeight: 'bold', color: '#a6a6a6', fontSize: 20, marginTop: 2, marginLeft: 50 }}>
                        ...
                        <Grid item lg={12} xs={12} style={{ marginTop: 40 }}>
                            <span className={styles.robotoFont} style={{ color: 'white', fontSize: 40, marginLeft: 50 }}>What i do! </span>
                        </Grid>

                        <Grid container justifyContent="left" spacing={2} style={{ marginLeft: 30 }}>
